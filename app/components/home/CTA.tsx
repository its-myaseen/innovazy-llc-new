...
const CTA = () => {
    ...
    return (
        <div className='flex py-24 relative w-full flex-col justify-center items-center gap-6 mb-42 box-border p-8 overflow-hidden'>
            ...
            <h2 className='block relative text-4xl sm:text-5xl font-semibold max-w-[550px] text-white font-poppins text-center'>{t('heading')}</h2>
            <p className='block relative  text-md sm:text-lg max-w-[580px] text-white/70 text-center leading-tight'>{t('description')}</p>

            <a href="tel:+966 535328007">
