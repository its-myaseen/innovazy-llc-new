...
const Hero = () => {
    ...
    return (
        <div className="flex justify-start sm:justify-center items-center relative w-full box-border min-h-screen bg-black max-w-full overflow-hidden">
            ...
            <div className='flex flex-col justify-center mt-18 items-start sm:items-center relative w-full'>
                ...
                <h1 className='block relative text-[55px] sm:text-[60px] leading-tight tracking-tight font-medium w-full sm:w-[75%] mt-6 text-start sm:text-center text-white/90 font-figtree'>{t('heading')}</h1>
                <p className='block relative font-poppins text-md text-white/70 mt-4 w-[85%] sm:w-[45%] text-shadow-transparent sm:text-center'>{t('description')}</p>
